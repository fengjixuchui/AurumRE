...
void UndefinedFunction_140014450(undefined8 device_object, longlong irp)
    ...
    if (mj_function == IRP_MJ_QUERY_SECURITY)
    {
      if ((DAT_140033a40 != (uint *)0x0) && (*DAT_140033a40 < 2000))
      {
        ...
        while (true)
        {
          ...
          uVar12 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + ((((uVar12 - lVar16 >> 1) + lVar16 >> 6) * 0x62 + uVar12 / 0x33) * -0x33 + uVar12 * 0x34) * 2) * 2000) % 0xc9d) * 0xe35) % 0xc9d;
          puStack592 = (ulonglong *)(&DAT_14002b760 +
          ...
          if ((DAT_140033a40 != (uint *)0x0) && (*DAT_140033a40 < 2000))
          {
            ...
            while (true)
            {
              ...
              if ((((ulonglong)puStack600 & 0xffffffff00000000 | 0xc8e4165300000000) -
                ...
                goto LAB_1400127c3;
              puStack600 = (ulonglong *)((uVar12 - 1) +
                                         (((~uVar12 & (ulonglong)puStack600) - (~(ulonglong)puStack600 | uVar12)) - (longlong)puStack600));
                    ...
                    if ((DAT_140033a40 != (uint *)0x0) && (*DAT_140033a40 < 2000))
                    {
                      ...
                      while (true)
                      {
                        ...
                        uVar12 = ((uVar12 + ((uVar12 - lVar16 >> 1) + lVar16 >> 0xb) * -0xe1b) *
                                 ...
                                 0x1107;
                        lVar16 = SUB168(ZEXT816(0x4e5e0a72f0539783) * ZEXT816(uVar12) >> 0x40, 0);
                        uVar12 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + ((((uVar12 - lVar16 >> 1) + lVar16 >> 6) * 0x62 + uVar12 / 0x33) * -0x33 + uVar12 * 0x34) * 2) * 2000) % 0xc9d) * 0xe35) %
                                 0xc9d;
                        puStack592 = (ulonglong *)(&DAT_14002b760 +
                                                   uVar12 * 0x90 +
  ...
  if (irpsp_flags < 0x14)
  {
    if ((DAT_140033a40 != (uint *)0x0) && (*DAT_140033a40 < 2000))
    {
      while (true)
      {
        ...
        uVar13 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + ((((uVar13 - lVar16 >> 1) + lVar16 >> 6) * 0x62 + uVar13 / 0x33) * -0x33 + uVar13 * 0x34) * 2) * 2000) % 0xc9d) * 0xe35) % 0xc9d;
        puStack592 = (ulonglong *)(&DAT_14002b760 +
  ...
  if (irp_sp_2->Control == 0x80012004)
  {
    ...
    uVar12 = (uVar13 >> 8) *
             (SUB168((ZEXT416(_DAT_fffff78000000004) << 0x20) *
                             ZEXT816(((ulonglong)_DAT_fffff78000000320 & 0xffffffff) << 8) >>
                         0x40,
                     0) -
                  0x3ffU >>
              0xb);
    ...
    else
    {
      ...
      puVar18 = puStack600;
      if ((CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11(*(undefined *)(puStack440 + 1),
                                                                          *(undefined *)((longlong)puStack440 + 9)),
                                                                 *(undefined *)((longlong)puStack440 + 10)),
           ...
           CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11(*(undefined *)puStack440,
                                                                 ...
                                                                 *(undefined *)((longlong)puStack440 + 2)),
        ...
        if (0xf < irp_2->Tail.Overlay.CurrentStackLocation->SecurityContext)
        {
          ...
          if ((DAT_140033a40 != (uint *)0x0) && (*DAT_140033a40 < 2000))
          {
            ...
            while (true)
            {
              ...
              uVar13 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + ((((uVar13 - lVar11 >> 1) + lVar11 >> 6) * 0x62 + uVar13 / 0x33) * -0x33 + uVar13 * 0x34) * 2) * 2000) % 0xc9d) * 0xe35) % 0xc9d;
            ...
            if (puStack568 != (ulonglong *)0x0)
            {
              ...
              if ((uVar17 != 0) && (uStack456 = 0, DAT_140033a40 != (uint *)0x0))
              {
                ...
                for (uStack80 = 0; uStack80 < 8; uStack80 = uStack80 + 1)
                {
                  ...
                  uVar12 = ((((ulonglong)(byte)(&DAT_140033988)
                                  [uVar12 * 4 + (uVar12 / 3 + (uVar12 / 10) * 10) * -3]
                              << 3) %
                             0xd) *
                            0xe) %
                           0xd;
                  puStack144 = (ulonglong *)((longlong)puStack144 * 0x100 +
                                             (ulonglong)(byte)(&DAT_1400339a8)
                                                 [uVar12 * 4 + (uVar12 / 3 + (uVar12 / 10) * 10) * -3]);
                }
                     ...
                     uStack456 = uStack456 + 1)
                {
                  ...
                  uVar12 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + ((((uVar12 - lVar11 >> 1) + lVar11 >> 6) * 0x62 + uVar12 / 0x33) * -0x33 + uVar12 * 0x34) * 2) * 2000) % 0xc9d) * 0xe35) % 0xc9d;
                  puStack592 = *(ulonglong **)(&DAT_14002b760 +
                                               uVar12 * 0x90 + ((uVar12 / 0xf5) * 0xf5 + uVar12 / 0x11) * -0x88);
                  uVar13 = (ulonglong)puStack592 >> 0x3c | (longlong)puStack592 << 4;
                  uVar12 = (~uVar13 & 0xfffffffffffffffe) + 1;
                  if (((uVar13 | uVar12) + (uVar13 & uVar12) ^ 1) +
                          (ulonglong)((int)uVar13 - 1U & 1) * 2 ==
                      0)
                    break;
                  uVar20 = (uint)((ulonglong)puStack144 >> 0x20);
                  uVar17 = (uint) ~(ulonglong)puStack592;
                  *(uint *)((longlong)puStack568 + (ulonglong)uStack456 * 4) =
                      ((uVar17 - ((~(uint)puStack592 | uVar20) * 2 + 2)) + 1 + uVar20 | 0xdc98993) - ((uVar17 - ((uVar17 | uVar20) * 2 + 2)) + 1 + uVar20 & 0xdc98993);
              ...
              *(ulonglong *)(irp_2 + 0x38) = (ulonglong)uVar19;
              ...
              if (DAT_140033a40 != (uint *)0x0)
              {
                ...
                for (uStack120 = 0; uStack120 < 2000; uStack120 = uStack120 + 1)
                {
                  ...
                  uVar13 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + (lVar11 * -0x33 + uVar22 * 0x34) * 2) *
                              2000) %
                             0xc9d) *
                            0xe35) %
                           0xc9d;
                  ...
                  *(ulonglong *)(&DAT_14002b760 + uVar13 * 0x90 + lVar16 * -0x88) =
                       ...
                       *(ulonglong *)(&DAT_14002b760 + uVar13 * 0x90 + lVar16 * -0x88))
                          << 0x20 ^
                      *(ulonglong *)(&DAT_14002b760 + uVar13 * 0x90 + lVar16 * -0x88);
                  uVar12 = ((((ulonglong) * (ushort *)((longlong)&DAT_140029050 + (lVar11 * -0x33 + uVar22 * 0x34) * 2) *
                              2000) %
                             0xc9d) *
                            0xe35) %
                           0xc9d;
                  *(ulonglong *)(&DAT_14002b760 +
                                 uVar12 * 0x90 + ((uVar12 / 0xf5) * 0xf5 + uVar12 / 0x11) * -0x88) =
                      *(ulonglong *)(&DAT_14002b760 +
                                     uVar12 * 0x90 + ((uVar12 / 0xf5) * 0xf5 + uVar12 / 0x11) * -0x88) &
                      0xefffffffffffffe0;
            ...
            else
            {
              if ((DAT_140033a40 != (uint *)0x0) && (*DAT_140033a40 < 2000))
              {
                ...
                while (true)
                {
                  ...
                  if ((~uVar14 & 0xfffffffffffffffe) + 2 + uVar14 == 0)
                    break;
                  if (((uVar12 & 0xffffffff00000000 | 0xc2d7a1d800000000) - (uVar22 << 0x20) |
                       uVar13 << 0x20) == (uVar15 & uVar13) << 0x20)
                    goto LAB_14000deea;
                  uVar12 = (uVar13 - 1) + (((~uVar13 & uVar12) - (~uVar12 | uVar13)) - uVar12);
    ...
    LAB_14000deea:
      ...
      uVar12 = (((((((auStack72._0_8_ & 0xff) << 8 | (ulonglong)auStack72[1]) << 8 |
                    (ulonglong)auStack72[2])
                       << 8 |
                   (ulonglong)auStack72[3])
                      << 8 |
                  (ulonglong)auStack72[4])
                     << 8 |
                 (ulonglong)auStack72[5])
                    << 8 |
                (ulonglong)auStack72[6])
                   << 8 |
               (ulonglong)auStack72[7];
      uVar13 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11(auStack72[8], uStack63), uStack62), uStack61), uStack60),
                                          uStack59),
                                 uStack58),
                        uStack57);
